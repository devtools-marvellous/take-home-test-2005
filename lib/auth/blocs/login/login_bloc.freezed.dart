...
abstract class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonStringConverter() FormInputModel<String> email,
      @JsonStringConverter() FormInputModel<String> password,
      BlocStatus status,
      String? formError});
...
class _$LoginStateImpl implements _LoginState {
  const _$LoginStateImpl(
      {@JsonStringConverter() required this.email,
      @JsonStringConverter() required this.password,
  ...
  @override
  String toString() {
    return 'LoginState(email: $email, password: $password, status: $status, formError: $formError)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, password, status, formError);
...
abstract class _LoginState implements LoginState {
  const factory _LoginState(
      {@JsonStringConverter() required final FormInputModel<String> email,
      @JsonStringConverter() required final FormInputModel<String> password,
      final BlocStatus status,
      final String? formError}) = _$LoginStateImpl;
